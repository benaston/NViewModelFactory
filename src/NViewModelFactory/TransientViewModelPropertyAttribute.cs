...
namespace NViewModelFactory
{
	...
	/// <summary>
	/// 	Responsible for providing the functionality for the decoration of dto properties to indicate that their state should not persist across HTTP requests.
	/// </summary>
	[AttributeUsage(AttributeTargets.Property)]
	public class TransientViewModelPropertyAttribute : Attribute {}
}