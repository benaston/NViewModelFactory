...
{
	/// <summary>
	/// 	Responsible for defining the interface for types that correspond to view models that are instantiated by the IOC container (rather than, say, directly in a controller).
	/// </summary>
	public interface IServiceLocatorInstantiatedViewModel : IViewModel {}
}